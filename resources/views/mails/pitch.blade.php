...
margin: auto;">
        ...
        <div style="position: relative">
            <div style="display: inline-block;background-color: #f48e35;background: linear-gradient(to right, #ff9029 0%, #fe6b37 100%);width: 100%;padding: 30 0 30 0;">
                ...
                <div align="center"> <img src="{{$message->embed((public_path().'/images/logo.svg'))}}" style="
    width:12em;
    height:auto;
...
width: 60%">
        ...
        <div style="padding: 2em 2em 1em 2em;margin: 1em 0 0 0;text-align: center;background-color: white;box-shadow: 0 0 7px 0px rgba(0,0,0,0.2);">
            <b>К запросу оставили новый питч</b>
            <p>Автор питча: &lt;pitch_author&gt; Из компании &lt;company_name&gt;
            </p>
            <div align="center"> <img src="https://image.flaticon.com/icons/svg/1533/1533235.svg" style="
    width: 6em;
    height:auto;
    margin: 1em;
   "></div><div style="border: 1px dashed gray; border-radius:5px; padding:1em;"><q>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</q></div>
            <a href="#" class="activate-link" style="
                                                   margin: 1em;
                                                   line-height: 50px;
                                                   background: #ff9029;
            ...
            <br><p>Репутация портала зависит от вашей работы</p></div>
                                    ...
                                    <table width="100%" cellpadding="0" style="border-collapse:collapse;border-radius:4px">
                                        ...
                                        <tr>
                                            <td align="center" style="-webkit-font-smoothing:subpixel-antialiased;color:#fff;font-size:14px;line-height:22px;text-align:center;">
                                                <img src="{{$message->embed((public_path().'/images/logo.svg'))}}" alt="" style="
    height: 30px;
"></td>
                                        </tr>
                                        </tbody>
