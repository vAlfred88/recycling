...
width: 60%">
        ...
        <div style="padding: 2em 2em 2em 2em;margin: 1em 0 0 0;text-align: center;background-color: white;box-shadow: 0 0 7px 0px rgba(0,0,0,0.2);">
            ...
            <p>C Вашего аккаунта был отправлен запрос на восстановлене пароля к аккаунту.
            </p>
            <div align="center"> <img src="{{$message->embed((public_path().'/img/mails/reset.svg'))}}" style="
    width: 6em;
    height:auto;
       margin: 1em;
"></div><p>Если этот запрос актуален, то Вы можете нажать сюда</p>
            <a href="{{url(route('home').route('password.reset', $token, false))}}" class="activate-link" style="
                                                   margin: 1em;
                                                   line-height: 50px;
                                                   background: #ff9029;
