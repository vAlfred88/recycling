...
width: 60%">
    ...
    height:auto;
    margin: 1em;
   "></div><p>Попробуйте насторить свой личный кабинет</p>
            <a href="{{route('password.update')}}" class="activate-link" style="
                                                   margin: 1em;
                                                   line-height: 50px;
                                                   background: #ff9029;
                                                   ...
                                                   border-radius: 30px;
                                                   ">Получить пароль для доступа</a>



            <br><p>Зайдите в свой личный кабинет, чтобы получить доступ к своему профилю и профилю компании</p></div>
