...
width: 60%">
    ...
    width: 6em;
    height:auto;
   "></div><p>{{$user->name}}, Вы зарегистрировались как физ.лицо, если Вы являетесь сотрудником компании, которая есть на нашей платформе, то попросите ее администратора добавить вас к ее сотрудникам </p>
            <a href="{{route('home')}}" class="activate-link" style="margin: 2em;
                                                   line-height: 50px;
                                                   background: #ff9029;
