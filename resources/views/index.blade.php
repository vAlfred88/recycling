        ...
        <div class="inner">
            ...
            <nav class="main_menu fright rL">
                ...
                <ul>
                    ...
                    <li class="city"><a>Санкт-Петербург</a></li>
                </ul>
            </nav>
            <div class="clear"></div>
        </div>
                ...
                <div class="row">
                    <div class="info_block">
                        ...
                        <div class="text_block rL hid">
                            Многие думают, что Lorem Ipsum - взятый с потолка псевдо. Многие думают, что Lorem Ipsum -
                            взятый с потолка псевдо. Многие думают, что Lorem Ipsum - взятый с потолка псевдо.
                            ...
                            <div class="item">
                                <div class="block">
                                    <div class="image_block m0a cover brd50"
                                         style="background-image: url(images/people.png);"></div>
                                    ...
                                    <a href="mailto:example@vtormet.com" class="email sb abs brd50">
                                        <svg width="20" height="14" viewBox="0 0 20 14" fill="none"
                                            ...
                                            <path d="M17.5489 13.7965H2.45105C1.65123 13.7965 1 13.1459 1 12.3455V2.45105C1 1.65065 1.65123 1 2.45105 1H17.5489C18.3488 1 19 1.65065 19 2.45105V12.3455C19 13.1459 18.3488 13.7965 17.5489 13.7965ZM2.45105 1.58042C1.97104 1.58042 1.58042 1.97104 1.58042 2.45105V12.3455C1.58042 12.8255 1.97104 13.2161 2.45105 13.2161H17.5489C18.029 13.2161 18.4196 12.8255 18.4196 12.3455V2.45105C18.4196 1.97104 18.029 1.58042 17.5489 1.58042H2.45105Z"
                                                  fill="#F49135" stroke="#F49135" stroke-width="0.3"/>
                                    ...
                                    <div class="item">
                                        <div class="people">
                                            <div class="image_block fleft rL hid brd50 cover"
                                                 style="background-image:url(images/no-people.png);"></div>
                                            <div class="rL hid">
                                        ...
                                        <div class="text_block">Давно сотрудничаем, у них большой спектр услуг и точек
                                            приема. Давно выяснено, что при оценке дизайна и композиции читаемый текст
                                            ...
                                            дубликации Давно сотрудничаем, у них большой спектр услуг и точек приема.
