...
Route::domain('my.' . config('app.url'))
     ->group(function () {
         Route::middleware('auth')->group(function () {
             ...
             Route::get('company', 'HomeController@show')
                  ->name('company');
             Route::resource('employees', 'EmployeeController');

             Route::name('company.')->namespace('Company')->group(function () {
                 Route::get('receptions/map', 'ReceptionController@showMap')
                      ->name('receptions.map');
                 Route::resource('receptions', 'ReceptionController');
             });
             ...
             Route::resource('users', 'UserController');
             Route::resource('services', 'ServiceController');
             Route::post('users/sendmail', 'UserController@sendMail')
                  ->name('send_email');
         });

         Route::get('register/recycle', 'Auth\RegisterController@companyRegister')
              ->name('company_register');
         Route::get('register/person', 'Auth\RegisterController@personRegister')
     ...
     ->group(function () {
         ...
         Route::name('front.')
              ...
              ->group(function () {
                  ...
                  Route::get('rating', 'RateController@index')
                       ->name('rating');
